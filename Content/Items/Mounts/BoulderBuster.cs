...
using LukaiAddons.Content.Buffs.Mounts;
using static LukaiAddons.LukaiUtils;
...
namespace LukaiAddons.Content.Items.Mounts
{
	public class BoulderBuster : ModMount
	{
		public override void SetStaticDefaults()
		{
			...
			MountData.buff = ModContent.BuffType<BoulderBusterBuff>();
			...
			{
				MountData.backTextureExtra = ModContent.Request<Texture2D>("LukaiAddons/Content/Items/Mounts/BoulderBusterExtra");
				MountData.frontTextureExtra = ModContent.Request<Texture2D>("LukaiAddons/Content/Items/Mounts/BoulderBusterExtra2");
